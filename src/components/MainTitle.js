...
const MainTitle = () => {
  ...
  return (
      <div className="w-screen aspect-video absolute top-0 text-white bg-gradient-to-tr from-black sm:pl-12 pl-5 min-h-[500px] max-h-screen ">
        <div className="absolute lg:bottom-48 bottom-40">
          ...
          <div className="flex w-fit py-2">
            <button
              ...
              className="p-2 px-6 my-1 bg-white bg-opacity-50 font-bold md:text-xl sm:text-md text-sm  rounded-md text-black z-40 hover:bg-red-600 hover:bg-opacity-70  hover:text-white duration-150"
            >
              More Info
            </button>
          </div>
