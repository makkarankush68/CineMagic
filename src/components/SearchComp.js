        ...
        <div className="pt-[144px] pb-10 w-screen">
          ...
          >
            ...
            <button
              ...
              className="relative inline-flex items-center justify-center py-2.5 overflow-hidden transition duration-300 ease-out shadow-xl group px-4 m-1 bg-purple-700 text-white mx-auto font-semibold rounded-full "
            >
