      ...
      <div className=" w-screen min-h-screen bg-bg-imgnt bg-fixed">
        ...
        <div className="pt-[144px] pb-10 w-screen">
          ...
          >
            <input
              ref={searchBar}
              className="rgb-border p-2 px-6 m-1 outline-none w-[40vw] min-w-[250px] mx-auto rounded-full text-white bg-gray-800 backdrop-blur-[2px] focus:shadow-lg bg-opacity-70"
              placeholder="What's on your mind?"
            />
            <button
              onClick={handleSearchClick}
              class="relative inline-flex items-center justify-center py-3 overflow-hidden transition duration-300 ease-out shadow-xl group hover:ring-1 hover:ring-purple-500  p-2 px-4 m-1 bg-purple-700 text-white mx-auto font-semibold rounded-full "
            >
